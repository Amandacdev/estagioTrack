...
// // Esse método localiza o usuário que deseja ver suas ofertas(ou)candidaturas
// e
// // chama o método adequado para a obtenção das mesmas
// @PostMapping("/identificar")
// public String pesquisarSolicitante(@RequestParam("emailFiltro") String
...
// // Email sem cadastro
// // else {
// // model.addAttribute("erro", "Não foi encontrado um cadastro com esse email.
// Tente novamente.");
// // return "consultaEstudanteEmpresa";
// // }
// }
