...
public class paginaUsuarioController {
    ...
    @Autowired
    public paginaUsuarioController(AlunoService alunoService, EmpresaService empresaService,
     ...
     * public String getEstudantePage(@RequestParam("emailFiltro") String
     * emailFiltro, Model model) {
     * 
     ...
     * return "paginaUsuario/candidaturasEstudante"; // Ou redirecionar para uma
     * página de erro
     * }
     * 
     * // Buscando as candidaturas do estudante
     * List<Candidatura> candidaturasDoUsuario =
     * candidaturaRepository.findByEmail(emailFiltro);
     * 
