--Povoando o banco de dados do EstagioTrack

--Para limpar seu banco, execute o comando a seguir
--TRUNCATE TABLE aluno, aluno_competencias, empresa, oferta, oferta_competencias, candidatura, competencia_template, users, authorities  CASCADE;

--Para deletar as tables, execute o comando a seguir
--DROP TABLE aluno, aluno_competencias, empresa, oferta, oferta_competencias, candidatura, competencia_template, users, authorities CASCADE;
